...
#define STRING_CONFIG_H_AUTHOR "(alex, printer2 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Alex Openbuilds"
...
#define HOTEND_OFFSET_X {0.0, 24.00} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define TEMP_SENSOR_BED 1  // TODO: set this properly
...
// my settings: M303 S150 C3 E1
// #define  DEFAULT_Kp 5.26
// #define  DEFAULT_Ki 0.35
// #define  DEFAULT_Kd 19.71
// M303 S200 C8 E0
#define  DEFAULT_Kp 24.98
#define  DEFAULT_Ki 2.18
#define  DEFAULT_Kd 71.61
// M303 S200 C5 E0
// #define  DEFAULT_Kp 3.59
// #define  DEFAULT_Ki 0.21
// #define  DEFAULT_Kd 15.61
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from pidautotune
  #define  DEFAULT_bedKp 683.34
  #define  DEFAULT_bedKi 75.15
  #define  DEFAULT_bedKd 1553.48
...
// 561
// 555.4455
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 106, 160, 794, 837 }
...
#define BLTOUCH
#if ENABLED(BLTOUCH)
  #define BLTOUCH_DELAY 80   // (ms) Enable and increase if needed
#endif
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.22   // Z offset: -below +above  [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION X_MAX_LENGTH - 21
  #define FRONT_PROBE_BED_POSITION 20
  #define BACK_PROBE_BED_POSITION Y_MAX_LENGTH - 21
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 500   // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
